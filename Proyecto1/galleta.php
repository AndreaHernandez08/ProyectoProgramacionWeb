...
<head>
    ...
    <title>Cachito de Cielo - Galletas</title>
...
<body>    <!--Encabezado (asi se comenta)-->
    ...
    <div class="grid">
        ...
        <div class="comida"> 
            <a>
                <img class="pro_imagen" src="img/oreo.png" alt="galleta oreo">
                <div class="pro_informacion">
                    <p class="pro_nombre">Galleta de Oreo</p>
                    <p class="pro_precio">$65</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_oreo">
                        <input type="hidden" name="name" value="Galleta de Oreo">
                        <input type="hidden" name="price" value="65.00">
                        <input type="hidden" name="image" value="img/oreo.png">
                        <input type="hidden" name="category" value="galletas">
       ...
       <div class="comida">
            <a>
                <img class="pro_imagen" src="img/lotu.png" alt="galleta de lotus">
                <div class="pro_informacion">
                    <p class="pro_nombre">Galleta de Lotus</p>
                    <p class="pro_precio">$70</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_lotus">
                        <input type="hidden" name="name" value="Galleta de Lotus">
                        <input type="hidden" name="price" value="70.00">
                        <input type="hidden" name="image" value="img/lotu.png">
                        <input type="hidden" name="category" value="galletas">
                        <input type="number" name="qty" value="1" min="1"> 
                        <button class="form_submit" type="submit">Agregar al carrito</button>
                    </form>
        ...
        <div class="comida">
            <a>
                <img class="pro_imagen" src="img/smore.png" alt="smore">
                <div class="pro_informacion">
                    <p class="pro_nombre">Galleta de Smore</p>
                    <p class="pro_precio">$70</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_smore">
                        <input type="hidden" name="name" value="Galleta de Smore">
                        <input type="hidden" name="price" value="70.00">
                        <input type="hidden" name="image" value="img/smore.png">
                        <input type="hidden" name="category" value="galletas">
                        <input type="number" name="qty" value="1" min="1"> 
                        <button class="form_submit" type="submit">Agregar al carrito</button>
                    </form>
        ...
        <div class="comida">
            <a>
                <img class="pro_imagen" src="img/principe.png" alt="principe">
                <div class="pro_informacion">
                    <p class="pro_nombre">Galletas de Principe</p>
                    <p class="pro_precio">$65</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_principe">
                        <input type="hidden" name="name" value="Galletas de Principe">
                        <input type="hidden" name="price" value="65.00">
                        <input type="hidden" name="image" value="img/principe.png">
                        <input type="hidden" name="category" value="galletas">
                        <input type="number" name="qty" value="1" min="1"> 
                        <button class="form_submit" type="submit">Agregar al carrito</button>
                    </form>
        ...
        <div class="comida">
            <a>
                <img class="pro_imagen" src="img/monster.png" alt="monster">
                <div class="pro_informacion">
                    <p class="pro_nombre">Monster Cookie (por temporada)</p>
                    <p class="pro_precio">$75</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_monster">
                        <input type="hidden" name="name" value="Monster Cookie (por temporada)">
                        <input type="hidden" name="price" value="75.00">
                        <input type="hidden" name="image" value="img/monster.png">
                        <input type="hidden" name="category" value="galletas">
                        <input type="number" name="qty" value="1" min="1"> 
                        <button class="form_submit" type="submit">Agregar al carrito</button>
                    </form>
        ...
        <div class="comida">
            <a>
                <img class="pro_imagen" src="img/cake.png" alt="cake">
                <div class="pro_informacion">
                    <p class="pro_nombre">Galletas Birthday Cake</p>
                    <p class="pro_precio">$70</p>
                    <form action="add_to_cart.php" method="post">
                        <input type="hidden" name="id" value="galleta_birthday">
                        <input type="hidden" name="name" value="Galletas Birthday Cake">
                        <input type="hidden" name="price" value="70.00">
                        <input type="hidden" name="image" value="img/cake.png">
                        <input type="hidden" name="category" value="galletas">
                        <input type="number" name="qty" value="1" min="1"> 
                        <button class="form_submit" type="submit">Agregar al carrito</button>
                    </form>
